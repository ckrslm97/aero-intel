...
# rather than generated: Stage 3's full airport/city reference dataset is not
# available on this branch, so this is the entire city vocabulary the
# classifier has, and city stays null for anything outside it. See
# app/llm/heuristic.py detect_risk_place().
#
