 ...
 * discount an editor.
 *
 * The shell -- backdrop, spring aside, Escape, scroll lock, focus trap, seam
 * light -- is components/ui/drawer-shell.tsx, shared with the other four
 * drawers. It is mounted and unmounted outright, never wrapped in
 * `AnimatePresence`; the measurement behind that is written out there.
 */
export function EventDetailDrawer({
  ...
  // return of focus to the trigger all live in `DrawerShell`.
  ...
  return (
    <DrawerShell
      ...
      glowColor={EVENT_TYPE_GLOW[event.event_type]}
      className="max-w-lg"
    >
