...
export function Sparkline({ data, positive = true, height = 36 }: SparklineProps) {
  ...
  // One sparkline per KPI card, so this is the option object rebuilt most
  // often in the app; with `notMerge` below, each rebuild was a full chart
  // teardown. It only depends on the series, its direction and the theme.
